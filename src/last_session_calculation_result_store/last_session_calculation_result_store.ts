...
class LastSessionCalculationResultStore {
  private constructor() {}

  public static async getExpression(): Promise<string> {
    return (
      await KeyValueStore.getItem(LAST_SESSION_CALCULATION_RESULT_STORE_KEY)
    ).toString();
  }
...
export default LastSessionCalculationResultStore;
