import DataEntity from "../../infrastructure/internals/entities/data_entity";
...
export const NOT_EXISTING_ITEM_ERROR_CAUSE: string =
  "The Chosen Item Does Not Exist In Key Value Store";
...
export function JSON_STRING_OF_OBJECT(value: any) {
  const storeData = new DataEntity(value);
